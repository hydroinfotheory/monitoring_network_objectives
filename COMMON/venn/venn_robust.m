...
% 20200305: Update SW to solve triangle inequality error
% see https://www.mathworks.com/matlabcentral/fileexchange/22282-venn
% comment by Florian Schwaiger
%
...
%               d = d12 or [d12 d13 d23]
    ...
    if nCirc==3
        ...
        if ~(srtD(end)<(srtD(1)+srtD(2)))
            warning('venn:triangleInequality', 'Triangle inequality not satisfied')
